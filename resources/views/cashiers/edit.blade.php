            ...
            <!-- /.box-header -->
              <div class="box-body">
                <div class="form-group @if ($errors->has('name')) has-error @endif">
                  ...
                  <input type="text" class="form-control" id="name" placeholder="Masukkan Nama Kasir" name="name" required value="@if(count($errors)>0){{ old('name') }}@else{{ $data->name }}@endif">
                  @if ($errors->has('name'))
